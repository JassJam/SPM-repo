...
macro(spm_log)
    if(SPM_VERBOSE_OUTPUT)
        list(JOIN ARGV " " _spm_log_msg)
        string(REPLACE "\\" "/" _spm_log_msg "${_spm_log_msg_escaped}")
        message(STATUS "[SPM]: ${_spm_log_msg_escaped}.")
    endif()
endmacro()
...
macro(spm_log_fatal)
    list(JOIN ARGV " " _spm_log_msg)
    string(REPLACE "\\" "/" _spm_log_msg "${_spm_log_msg_escaped}")
    message(FATAL_ERROR "[SPM]: ${_spm_log_msg_escaped}.")
endmacro()
...
macro()
    if(SPM_VERBOSE_OUTPUT)
        ...
        foreach(_arg IN LISTS ARGV)
            string(REPLACE "\\" "/" _arg_safe "${_arg}")
            string(APPEND _spm_log_msg "${_arg_safe}")
        endforeach()
        message(FATAL_ERROR "[SPM]: ${_spm_log_msg}.")
    endif()
endmacro()
