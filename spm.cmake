...
function(_spm_get_build_hash name version git_url git_tag url url_hash configs build_type build_shared out_hash)
	string(SHA256 _hash
		"${name}-${version}-${git_url}-${git_tag}-${url}-${url_hash}-${configs}-${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}-${CMAKE_CXX_COMPILER_ID}-${CMAKE_CXX_COMPILER_VERSION}-${build_type}-${build_shared}-${CMAKE_GENERATOR}-${CMAKE_C_FLAGS}-${CMAKE_CXX_FLAGS}")
